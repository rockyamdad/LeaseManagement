...
class CourtFeeType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('normalCourtFee', 'text', array(
                'required'    => false,
                'attr' => array('class' => 'form-control input-small mask_en_decimal', 'maxlength' => 6),
            ))
            ->add('emergencyCourtFee', 'text', array(
                'required'    => false,
                'attr' => array('class' => 'form-control input-small mask_en_decimal', 'maxlength' => 6),
            ))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\CourtFee'
        ));
    }

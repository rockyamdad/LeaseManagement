...
(function () {
    ...
    var fileTypeExt = {
        ...
        "document": 'doc|pdf|docx|txt|log|msg|pages|rtf|wpd|wps|indd|qxd|xlsx|pps|ppt|pptx|qxp|csv|sql|xls',
    ...
    SFileInput.prototype = {
        ...
        _createInput: function () {
            ...
            addEvent(input, 'change', function () {
                ...
                if (false === self._settings.onChange.call(self, file, ext, self)) {
                    return;
                }
        ...
        _createRemoveButton: function (el, temp) {
            ...
            remove.innerHTML = "<span style='margin-left: 10px' class='btn btn-danger btn-xs'>Remove</span>";

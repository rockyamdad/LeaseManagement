...
class CorrectionRequestPorchaAcLandType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('khatianNo', null, array(
                'required' => true,
                'attr' => array('class' => 'bn-digit', 'maxlength' => '5','banglaDigitsOnly'=>true)
            ))
            ->add('correctionReason', null, array('attr' => array('class' => 'form-control')))
            ->add('correctionInfo', null, array('attr' => array('class' => 'form-control')));

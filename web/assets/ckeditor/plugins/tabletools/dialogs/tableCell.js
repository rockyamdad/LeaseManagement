            ...
            id: "info", label: c.title, accessKey: "I", elements: [{
                type: "hbox", widths: ["40%", "5%", "40%"], children: [{
                    ...
                    children: [{
                        ...
                        "default": "",
                        setup: d(function (a) {
                                var b = a.getAttribute("borderWidth");
                                return a.getStyle("border-width") || b
                            }), commit: function (a) {
                                this.getValue() ? a.setStyle("border-width", this.getValue()) : a.removeStyle("border-width");
                                a.removeAttribute("borderWidth")
                            }
